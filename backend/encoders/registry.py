...
MODEL_REGISTRY: dict[str, ModelSpec] = {
    ...
    "llava_onevision_qwen2_05b_image_only": ModelSpec(
        key="llava_onevision_qwen2_05b_image_only",
        family="LLaVA-OneVision",
        label="LLaVA-OneVision · Qwen2 · 0.5B · image only",
        provider="llava_onevision_visual",
        model_id="llava-hf/llava-onevision-qwen2-0.5b-ov-hf",
        published="2024",
        description="Experimental generative VLM used here only as a pooled visual feature extractor.",
        requires=("torch", "transformers"),
        recommended_batch_size=1,
        notes="VLM generative model used only for pooled visual features in this app; it is not wired for text embeddings or semantic text search.",
        supports_image_embedding=True,
        supports_text_embedding=False,
        supports_text_search=False,
        supports_projection=True,
        recommended_for=("visual_similarity", "advanced_multimodal"),
        hardware_tier="gpu_recommended",
        status="experimental",
    ),
    "qwen25_vl_3b_image_only": ModelSpec(
        key="qwen25_vl_3b_image_only",
        family="Qwen2.5-VL",
        label="Qwen2.5-VL · 3B · image only",
        provider="qwen25_vl_visual",
        model_id="Qwen/Qwen2.5-VL-3B-Instruct",
        published="2025",
        description="Experimental generative VLM used here only as a pooled visual feature extractor.",
        requires=("torch", "transformers"),
        recommended_batch_size=1,
        notes="Used only for pooled visual features in this app; it can require a GPU and substantial memory, and it does not enable semantic text search.",
        supports_image_embedding=True,
        supports_text_embedding=False,
        supports_text_search=False,
        supports_projection=True,
    ...
    "metaclip2_worldwide_h14": ModelSpec(
        ...
        model_id="",
        published="planned",
        description="Roadmap entry for MetaCLIP 2 worldwide H/14 checkpoints.",
    ...
    "metaclip2_worldwide_b32": ModelSpec(
        ...
        requires=("torch", "transformers"),
        recommended_batch_size=8,
        notes="Experimental, locally smoke-tested for image/text embeddings and UMAP projection. Requires a recent Transformers build and downloads the checkpoint on first use.",
        supports_image_embedding=True,
        supports_text_embedding=True,
        supports_text_search=True,
        supports_projection=True,
    ...
    "mobileclip2_s2": ModelSpec(
        ...
        requires=("torch", "open_clip"),
        recommended_batch_size=32,
        notes="Experimental, locally smoke-tested for image/text embeddings and UMAP projection. Uses the timm OpenCLIP-compatible Hugging Face checkpoint and downloads weights on first use.",
        supports_image_embedding=True,
        supports_text_embedding=True,
        supports_text_search=True,
        supports_projection=True,
    ...
    "eva_clip_l14": ModelSpec(
        ...
        model_id="",
        published="planned",
        description="Roadmap entry for a practical EVA-CLIP local variant.",
        notes="Planned until a verified local checkpoint and loader are added.",
        supports_image_embedding=False,
        supports_projection=False,
    ...
    "eva_clip_bigE14": ModelSpec(
        ...
        model_id="",
        published="planned",
        description="Roadmap entry for the stronger practical EVA-CLIP variant.",
        notes="Advanced planned option; huge EVA variants are intentionally not defaults.",
        supports_image_embedding=False,
        supports_projection=False,
        recommended_for=("visual_similarity", "art_collection"),
        hardware_tier="large_gpu",
    ...
    "laclip_roadmap": ModelSpec(
        ...
        model_id="",
        published="planned",
        description="Roadmap entry for future patch-aware cultural heritage retrieval.",
        notes="Planned until a stable global embedding checkpoint and loader are available.",
        supports_image_embedding=False,
        supports_text_embedding=False,
        supports_text_search=False,
